...
<?php
	...
	public static function upload_and_send($file)
	{
		...
		//$read_file_handle = fopen ( $localfile, 'r' );
		...
		<?php screen_icon(); ?>
			...
			<form name="form1" method="post"
				...
				<table width="100%" cellpadding="5" class="form-table">
					...
					<tr valign="top">
						<th scope="row"><label for="rest_port"><?php _e('REST API server port', self::textdomain) ?>:</label></th>
						<td>
					...
					<tr valign="top">
						<th scope="row"><label for="rest_pwd"><?php _e('REST API password', self::textdomain) ?>:</label></th>
						<td>
					...
					<tr valign="top">
						...
						<td>
							...
							<span class="description"><?php _e('Remote base URL,the URL to your bucket root path.for example: <strong>http://xxx.b0.upaiyun.com</strong>.', self::textdomain); ?></span>
						</td>
					</tr>
					<tr valign="top">
						<th scope="row"><label for="rest_remote_path"><?php _e('rest Remote path', self::textdomain); ?>:</label></th>
						<td>
							...
							<span class="description"><?php _e('the relative path to your bucket main directory.Use "<strong>.</strong>" for rest main(root) directory.You can use sub-directory Like <strong>wp-files</strong>', self::textdomain); ?></span>
						</td>
					</tr>
					<tr valign="top">
