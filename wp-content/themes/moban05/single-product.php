...
<div class="ym">
    ...
    <div class="ym3">
         <div class="ym3_1">
              <div class="zb">
                  <div class="f1">
                      <h1><?php echo $cat->name; ?></h1><b>Products</b>
                  </div>
                  <div class="f2">
              ...
              <div class="yb">
                   ...
                   <div class="g2">
                        ...
                        <?php if (have_posts()) : while (have_posts()) : the_post(); ?>
                             <h3><?php the_title(''); ?></h3>
                             <div class="cp2_1">TIME:<?php the_time('20y-m-d')?></div>
                             <?php if (has_post_thumbnail()): ?>
                             <!--div class="cp2_2">
                                  <?php the_post_thumbnail('full'); ?>
                                  <div class="cp2_3"><img src="<?php bloginfo('template_url'); ?>/images/cpb.png" /></div>
                             </div-->
                             <?php endif; ?>
                             <div class="cp2_4">
                                  <h4>Product</h4><h5>产品描述</h5>
                             </div>
                             <div class="cp2_5">
                                  <?php the_content(); ?>
