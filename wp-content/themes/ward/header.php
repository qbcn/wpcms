...
<!--[if IE]><![endif]--><!--script src="http://html5shiv.googlecode.com/svn/trunk/html5.js"></script-->
<?php wp_head(); ?>
</head>
		...
		<header class="navbar-inverse navbar navbar-fixed-top" role="navigation">
			<div class="container">
				<div class="navbar-header">
					...
					<a id="site-title" class="navbar-brand" href="<?php echo esc_url( home_url() ); ?>" title="<?php echo esc_attr( get_bloginfo( 'name', 'display' ) ); ?>" rel="home"><img src="http://bcs.duapp.com/cmsmedia/logo_qbw.png"/></a>
				</div>
