...
$wp_customize->add_setting('mytheme_footer_box1_title', array(
    ...
    $wp_customize->add_control('mytheme_footer_box1_title', array(
        'label'      => __('底部第一个模块的名称', 'mytheme_footer_box1_title'),
...
$wp_customize->add_setting('mytheme_footer_box2_title', array(
        'default'        => ' ',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control('mytheme_footer_box2_title', array(
        'label'      => __('底部第二个模块的名称', 'mytheme_footer_box2_title'),
        'section'    => 'mytheme_footer_options',
        'settings'   => 'mytheme_footer_box2_title',
		 'description' => '选项不填写则整个模块不会显示',
    ));

$wp_customize->add_setting('mytheme_footer_box2_link', array(
        'default'        => ' ',
        'capability'     => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control('mytheme_footer_box2_link', array(
        'label'      => __('底部第二个模块的链接', 'mytheme_footer_box2_link'),
        'section'    => 'mytheme_footer_options',
        'settings'   => 'mytheme_footer_box2_link',
		 'description' => '填写链接',
    ));
  ...
  $wp_customize->add_setting('mytheme_footer_box2_pic', array(
   ...
   $wp_customize->add_setting('mytheme_footer_box2_text', array(
    ...
    $wp_customize->add_control(new Ari_Customize_Textarea_Control($wp_customize, 'mytheme_footer_box2_text', array(
         'label'      => __('模块2文字信息', 'mytheme_footer_box2_text'),
         'section'    => 'mytheme_footer_options',
...
$wp_customize->add_setting('mytheme_footer_box3_title', array(
    ...
    $wp_customize->add_control('mytheme_footer_box3_title', array(
        'label'      => __('底部第3个模块的名称', 'mytheme_footer_box3_title'),
        'section'    => 'mytheme_footer_options',
...
$wp_customize->add_setting('mytheme_footer_box3_link', array(
    ...
    $wp_customize->add_control('mytheme_footer_box3_link', array(
        'label'      => __('底部第3个模块的链接', 'mytheme_footer_box3_link'),
        'section'    => 'mytheme_footer_options',
...
$wp_customize->add_setting('mytheme_footer_grel', array(
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_footer_grel', array(
        'label'    => __('底部所有灰色色字体', 'extraordinaryvision'),
        'section'  => 'mytheme_footer_options',
        'settings' => 'mytheme_footer_grel',
    )));	
	
	$wp_customize->add_setting('mytheme_footer_blue', array(
	    'default'        => '#11a3c2',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_footer_blue', array(
        'label'    => __('底部所有灰色色字体', 'extraordinaryvision'),
        'section'  => 'mytheme_footer_options',
        'settings' => 'mytheme_footer_blue',
    )));	
