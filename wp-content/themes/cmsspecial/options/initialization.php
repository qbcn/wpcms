...
function mytheme_initialization_options($wp_customize){
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_index_blue', array(
        'label'    => __('首页模块中，所有蓝色，以及鼠标经过的蓝色色值调整', 'extraordinaryvision'),
 ...
 $wp_customize->add_setting('mytheme_search_color', array(
    ...
    $wp_customize->add_setting('mytheme_time_color', array(
	    'default'        => '#117dc2',
        'sanitize_callback' => 'sanitize_hex_color',
        'capability'        => 'edit_theme_options',
        'type'           => 'option',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_time_color', array(
        'label'    => __('时间颜色调整', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
        'settings' => 'mytheme_time_color',
    )));
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_title_color', array(
        'label'    => __('标题颜色调整', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
    ...
    $wp_customize->add_control( new WP_Customize_Color_Control($wp_customize, 'mytheme_link_color', array(
        'label'    => __('内页连接文字颜色', 'extraordinaryvision'),
        'section'  => 'mytheme_initialization_options',
