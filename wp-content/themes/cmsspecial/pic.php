  <?php               $picss=get_option('mytheme_picss'); 
				    ...
				    if($picss){$pic_hight=$picss."px";}else{$pic_hight='400px';}
...
<div id="photo_full_in">
 <ul class="slides">                                     
<?php if ($pic1 !=""){ ?>			   
    <li><a  href="<?php  echo $pic_link1?>"<?php echo $pic_taget1; ?> style="height:<?php echo $pic_hight; ?>; background: center url(<?php echo  $pic1;?>)" title="<?php echo  $pic_content1;?>" >
  
     </a>
     </li>
  <?php }; ?>     
  <?php if ($pic2 !=""){ ?>			   
    <li><a href="<?php  echo $pic_link2?>"<?php echo $pic_taget2; ?> style="height:<?php echo $pic_hight; ?>; background: center url(<?php echo  $pic2;?>)"  title="<?php echo  $pic_content2;?>" >  
   
    </a></li>
  <?php }; ?>         
 <?php if ($pic3 !=""){ ?>			   
   <li><a href="<?php  echo $pic_link3?>"<?php echo $pic_taget3; ?> style="height:<?php echo $pic_hight; ?>; background: center url(<?php echo  $pic3;?>)" title="<?php echo  $pic_content3;?>" >
     </a>></li>
  <?php }; ?>                                            
  <?php if ($pic4 !=""){ ?>			   
    <li><a href="<?php  echo $pic_link4?>" <?php echo $pic_taget4; ?> style="height:<?php echo $pic_hight; ?>; background: center url(<?php echo  $pic4;?>)" title="<?php echo  $pic_content4;?>" >
