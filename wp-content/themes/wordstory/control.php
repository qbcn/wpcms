...
$options = array (
	...
	array("name" => "首页第一屏幻灯设置","type" => "heading","desc" => ""),
	array("name" => "幻灯图片","id" => $shortname."_homeimg_a_1","std" => "","type" => "text"),
	array("name" => "幻灯标题","id" => $shortname."_homeimg_b_1","std" => "","type" => "text"),
	array("name" => "幻灯简介","id" => $shortname."_homeimg_c_1","std" => "","type" => "text"),
	array("name" => "幻灯按钮文字","id" => $shortname."_homeimg_d_1","std" => "","type" => "text"),
	array("name" => "幻灯按钮链接","id" => $shortname."_homeimg_e_1","std" => "","type" => "text"),
	array("name" => "首页第二屏幻灯设置","type" => "heading","desc" => ""),
	array("name" => "幻灯图片","id" => $shortname."_homeimg_a_2","std" => "","type" => "text"),
	array("name" => "幻灯标题","id" => $shortname."_homeimg_b_2","std" => "","type" => "text"),
	array("name" => "幻灯简介","id" => $shortname."_homeimg_c_2","std" => "","type" => "text"),
	array("name" => "幻灯按钮文字","id" => $shortname."_homeimg_d_2","std" => "","type" => "text"),
	array("name" => "幻灯按钮链接","id" => $shortname."_homeimg_e_2","std" => "","type" => "text"),
	array("name" => "首页第三屏幻灯设置","type" => "heading","desc" => ""),
	array("name" => "幻灯图片","id" => $shortname."_homeimg_a_3","std" => "","type" => "text"),
	array("name" => "幻灯标题","id" => $shortname."_homeimg_b_3","std" => "","type" => "text"),
	array("name" => "幻灯简介","id" => $shortname."_homeimg_c_3","std" => "","type" => "text"),
	array("name" => "幻灯按钮文字","id" => $shortname."_homeimg_d_3","std" => "","type" => "text"),
	array("name" => "幻灯按钮链接","id" => $shortname."_homeimg_e_3","std" => "","type" => "text"),
);
