...
<div class="form-group">
    <input type="text" class="form-control" name="author" id="comment-author" placeholder="名字">
</div>
<div class="form-group">
    <input type="text" class="form-control" name="email" id="comment-email" placeholder="Email">
</div>

<?php endif; ?>

<button type="submit" class="btn btn-danger"><i class="glyphicon glyphicon-ok-circle"></i> 提交</button>
